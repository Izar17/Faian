		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addLayawayModel"> <i
							class="glyphicon glyphicon-plus-sign"></i> Add Customer </button>
				</div> <!-- /div-action -->

					<table class="table table-bordered table-striped table-hover datatable datatable-Customer"
						id="manageCustomerTable">
						<thead>
							<tr>
								<th>Customer Name</th>
								<th>Address</th>
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitLayawayForm" action="php_action/createCustomer.php" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="customerName" placeholder="Full Name"
								name="customerName" autocomplete="off" required />
						</div>
					</div> <!-- /form-group-->
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="customerAddress" placeholder="Address"
								name="customerAddress" autocomplete="off" required />
						</div>
					</div> <!-- /form-group-->
					<div class="form-group">
						...
						<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="customerNumber" placeholder="Contact Number"
								name="customerNumber" autocomplete="off" required />
						</div>
					</div> <!-- /form-group-->
				</div> <!-- /modal-body -->
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary" id="createLayawayBtn" data-loading-text="Loading..."
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="editCustomerForm" action="php_action/editCustomer.php" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="editCustomerName"
									placeholder="Customer Name" name="editCustomerName" autocomplete="off">
							</div>
						</div> <!-- /form-group-->
						<div class="form-group">
							<label for="address" class="col-sm-3 control-label">Address</label>
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="editCustomerAddress" placeholder="Address"
									name="editCustomerAddress" autocomplete="off" required />
							</div>
						</div> <!-- /form-group-->
						<div class="form-group">
							<label for="customerNumber" class="col-sm-3 control-label">Contact Number </label>
							<label class="col-sm-1 control-label">: </label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="editCustomerNumber"
									placeholder="Contact Number" name="editCustomerNumber" autocomplete="off"
									required />
							</div>
						</div> <!-- /form-group-->
					</div>
				...
				<div class="modal-footer editCustomerFooter">
					...
					<button type="submit" class="btn btn-success" id="editCustomerBtn" data-loading-text="Loading..."
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer removeCustomerFooter">
				<button type="button" class="btn btn-default" data-dismiss="modal"> <i
						class="glyphicon glyphicon-remove-sign"></i> Close</button>
				<button type="button" class="btn btn-primary" id="removeCustomerBtn" data-loading-text="Loading..."> <i
						class="glyphicon glyphicon-ok-sign"></i> Yes</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
